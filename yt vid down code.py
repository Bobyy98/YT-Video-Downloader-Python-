    ...
    try:
        ...
        if resolution == '' and video_link == '':
            ...
            try:   
                ...
                video = YouTube(video_link, on_progress_callback=on_progress, use_oauth=True, allow_oauth_cache=True)
...
label_style.configure('TLabel', foreground='#000000', font=('Serif', 18))

entry_style = ttk.Style()
entry_style.configure('TEntry', font=('Dotum', 15))

button_style = ttk.Style()
button_style.configure('TButton', foreground='#000000', font='Serif')
...
search_resolution = ttk.Button(window, text='Set Resolution', command=searchThread)
